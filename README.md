...
**Название приложения** — это настольное приложение на базе Qt 6, предназначенное для мониторинга, управления и анализа данных, поступающих от сети удаленных датчиков.
...
*   **Загрузка данных:** Поддерживается два режима загрузки данных:
    ...
    2.  **По UART:** Прямая загрузка данных с устройства через последовательный порт. Не протестированно.
